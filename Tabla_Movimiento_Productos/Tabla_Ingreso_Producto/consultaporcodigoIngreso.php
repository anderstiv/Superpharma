...
function validar(formulario)
{
	...
	{
		alert('Sr Usuario debe ingresar el codigo del del ingreso del producto');
...
<center>
<form id="form1" name="form1" method=post onsubmit="return validar(this)" action="consultarproIngreso.php">
