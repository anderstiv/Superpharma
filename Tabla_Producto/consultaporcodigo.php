...
{
	if(form1.txtcodproducto.value=='')
	{
		alert('Sr Usuario debe ingresar el codigo del producto a consultar');
		formulario.txtcodproducto.focus();
		return false;
	}
	else if (isNaN(form1.txtcodproducto.value))
	{
...
<form id="form1" name="form1" method=post onsubmit="return validar(this)" action="consultarpro.php">
  <table width="400" border="1">
    <tr>
      ...
      <td>
        <input name="txtcodproducto" type="number" id="txtcodproducto" size=25/>
      </td>
    </tr>
    <tr>
      <td>
