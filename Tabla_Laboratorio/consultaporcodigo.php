...
function validar(formulario)
{
	...
	{
		alert('Sr Usuario debe ingresar el ID del laboratorio a consultar');
...
<center>
<form id="form1" name="form1" method=post onsubmit="return validar(this)" action="consultarlab.php">
